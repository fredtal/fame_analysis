...
importdir <- "~/Documents/Rutgers/fatty acids/Jen's data 20151209/1.txt files (original)"

# tempdir1: empty (this will hold the tab-delimited files converted from text)
tempdir1 <- "~/Documents/Rutgers/fatty acids/Jen's data 20151209/2.csv files (tab-delimited, with header)"

# tempdir2: empty (this will hold the comma-delimited files converted from 
#                  tempdir1 with all the header junk still at the top)
tempdir2 <- "~/Documents/Rutgers/fatty acids/Jen's data 20151209/3.csv files (comma-delimited, with header)"

#tempdir3: empty (this will hold csv files with no header but all columns
tempdir3 <- "~/Documents/Rutgers/fatty acids/Jen's data 20151209/4.csv files (no header, all columns)"

#exportdir: empty (this will hold csv files with no header but all columns
exportdir <- "~/Documents/Rutgers/fatty acids/Jen's data 20151209/5.csv files (rt, ap only)"
